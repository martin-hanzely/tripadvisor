...
setup(
    ...
    url="https://github.com/martin-hanzely/tripadvisor",  # Optional
    ...
    install_requires=["certifi==2023.7.22; python_version >= '3.6'", "charset-normalizer==3.2.0; python_full_version >= '3.7.0'", "idna==3.4; python_version >= '3.5'", 'requests==2.31.0', "urllib3==2.0.4; python_version >= '3.7'"],  # Optional
    ...
    project_urls={  # Optional
        "Bug Reports": "https://github.com/martin-hanzely/tripadvisor/issues",
        # "Funding": "https://donate.pypi.org",
        # "Say Thanks!": "http://saythanks.io/to/example",
        "Source": "https://github.com/martin-hanzely/tripadvisor/",
    },
)
